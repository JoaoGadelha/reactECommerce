...
const Carousel2 = () => {
    ...
    let position = 0;
    const numVis4 = useMediaQuery({query: '(min-width: 1000px)'});
    const numVis3 = useMediaQuery({ query: '(max-width: 1000px) and (min-width: 900px)' });
    const numVis2 = useMediaQuery({ query: '(max-width: 900px)' });
